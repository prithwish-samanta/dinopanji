    ...
    return (
        <div className="mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
                ...
                <p className="text-muted-foreground">Bengali Year {year}</p>
            </div>
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center">
                    <button onClick={onPrevYear}
                            className="p-2 rounded-md hover:bg-zinc-200/50"><ChevronsLeft
                        size={20}/></button>
                    ...
                    <button onClick={onNextYear}
                            className="p-2 rounded-md hover:bg-zinc-200/50"><ChevronsRight
                        size={20}/></button>
                </div>
            </div>
        </div>
